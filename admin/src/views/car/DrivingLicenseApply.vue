<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table
      ...
      <el-table-column min-width="120" align="center" label="业务流水号">
        <template slot-scope="scope">
          <span>{{ scope.row.flowNumber }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column min-width="120" align="center" label="邮寄地址">
        <template slot-scope="scope">
      ...
      <el-table-column min-width="120" align="center" label="驾驶证信息">
        <template slot-scope="scope">
          <span>{{ scope.row.dlId }}</span>
        </template>
      </el-table-column>
      <el-table-column min-width="120" align="center" label="办证类型">
        <template slot-scope="scope">
...
<script>
import { fetchDrivingLicenseApplyList } from '@/api/car/car'
...
export default {
  ...
  methods: {
    getList() {
      ...
      fetchDrivingLicenseApplyList(this.listQuery).then(response => {
