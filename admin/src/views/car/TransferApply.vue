<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table
      ...
      <el-table-column min-width="120" align="center" label="迁入迁出地">
        <template slot-scope="scope">
          <span>{{ scope.row.targetAreaId }}</span>
        </template>
      </el-table-column>
...
<script>
import { fetchTransferApplyList } from '@/api/car/car'
...
export default {
  ...
  methods: {
    getList() {
      ...
      fetchTransferApplyList(this.listQuery).then(response => {
