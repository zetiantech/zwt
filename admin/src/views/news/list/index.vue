<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table
      ...
      <el-table-column min-width="120" align="center" label="资讯标题">
        <template slot-scope="scope">
          <span>{{ scope.row.title }}</span>
        </template>
      </el-table-column>
      <el-table-column min-width="120" align="center" label="分类">
        <template slot-scope="scope">
      ...
      <el-table-column min-width="150" align="center" label="内容">
        <template slot-scope="scope">
