...
import { 
 ...
 const LockModeComponent = ({props, isValid, onChangeHander}) => {
	return (
		<View style={styles.mainBox}>
			...
			<View style={styles.headBox}>
				<Text style={{fontSize: 16, color: '#666'}}>选择解锁方式</Text>
			</View>
 ...
 export default function LockMode(props){
	 ...
	 return (
		<Provider>
			<View style={styles.container}>
				<LockModeComponent props={props} isValid={isValid} onChangeHander={onChangeHander} />
