    ...
    return (
        <View style={styles.headerBox}>
            <ImageBackground
                ...
                <Text style={styles.titleStyles}>公租房</Text>
            </ImageBackground>
        </View>
    )
}
    ...
    const listData = [
        {
            ...
            title: '公租房申请',
            list: [
                { id: 11, title: '户籍家庭公租房申请', handler: ()=>{ 
                    NavigationUtil.navigate(props,'Housing')
                 } }
            ]
        },
        {
            ...
            title: '住房补贴',
            list: [
                { id: 21, title: '高层次人才住房补贴申请', handler: ()=>{ 
                    NavigationUtil.navigate(props,'TalentsHousimg')
                 } }
            ]
        },
        // {
    ...
    return (
        <Provider>
            <View style={styles.container}>
                <NavigationBar 
                    statusBar={{backgroundColor: '#0695A3', barStyle: 'light-content'}}
                    title='出入境服务'
                    hide={true}/>
                <ScrollView>
                    <Header props={props} />
