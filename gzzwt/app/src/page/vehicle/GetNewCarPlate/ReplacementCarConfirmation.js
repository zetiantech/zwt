...
export default function ReplacementCarConfirmation (props) { 
        const busType = props.navigation.getParam('busType')//上级页面 车辆类型文本数据
        ...
        const formData = props.navigation.getParam('formData')//获取方式文本数据
        let time = new Date()
      
        console.log(formData,9999999999)
        function onButtonClick () {  
            ...
            HttpUtil.post(API.VehicleApplyAddRptPlateApply, {
                ...
                needTmpPlateNo:formData.needTmpPlate.join(''),
            ...
            const { code, data, msg } = responseJson.data   
                if(code === 0){  
                    console.log(data,33)
                    NavigationUtil.navigate(props,'Result',{carData:carData,bustypetwo:bustypetwo,textData:data,time:time})
    ...
    {  carData && busType && bustypetwo && rptReasonIdtwo && getakeWayText&&
            <ScrollView
                style={{ flex: 1,}}
            ...
            >
                ...
                <View style={styles.titleBox}>
                    <Text style={styles.titleText}>临时号牌取件信息</Text>
                </View>
                <View style={styles.infoBox}>
                    <Flex style={styles.infoBoxItem}>
                        <Flex.Item style={{flex: 0.5}}>
                        ...
                        <Flex.Item>
                           <Text style={styles.infoContent}>{formData.sendName}</Text>
                        </Flex.Item>
                    </Flex>
                    <Flex style={styles.infoBoxItem}>
                        <Flex.Item style={{flex: 0.5}}>
                        ...
                        <Flex.Item>
                           <Text style={styles.infoContent}>{formData.phone}</Text>
                        </Flex.Item>
                    </Flex>
                    <Flex style={styles.infoBoxItem}>
                        <Flex.Item style={{flex: 0.5}}>
                        ...
                        <Flex.Item>
                           <Text style={styles.infoContent}>{formData.sendAddress}</Text>
                        </Flex.Item>
                    </Flex>
                </View>
                <View style={styles.titleBox}>
               ...
               {/*  */}
                <View style={{marginTop:20,backgroundColor: '#ffffff',padding:15}}>
                    <View style={styles.titleBox1}>
                        <Text style={styles.titleText1}>工本费</Text>
                    </View>
                    <Flex style={styles.infoBoxItem}>
