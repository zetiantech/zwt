        ...
        <View style={styles.listWrap}>
            {
                data.map((item, index) => {
                    return (
                        <TouchableOpacity key={index} onPress={() => NavigationUtil.navigate(props, 'MotorVehicleDetails', { info: { ...item, score: `-${item.score}`, statusText: { 1: '未处理', 2: '已处理' }[item.status] } })}>
...
export default function MotorVehicleResults(props) {
