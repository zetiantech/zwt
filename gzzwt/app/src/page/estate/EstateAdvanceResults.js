...
export default function EstateAdvanceResults (props) {
    ...
    return (
        <View style={styles.container}>
            <NavigationBar title='预售证信息查询结果' hide={false} navigator={props.navigation} popEnabled={true} />
            <WhiteSpace size="lg" />
            <ScrollView >
