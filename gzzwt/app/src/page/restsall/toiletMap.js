...
function Parking({ data, getData, setListView, props }) {
    return (
        <View style={styles.ParkingBox}>
            <Text style={styles.parkTitle}>共找到{data.count}公厕</Text>
...
export default function ToiletMap(props) {
    const [keywords, setKeywords] = useState();
    ...
    return (
        <Provider>
            <View style={styles.container}>
                <NavigationBar title='公共厕所' navigator={props.navigation}
                ...
                <View style={styles.mapWrap}>
                    ...
                    <View style={styles.ParkingBox}>
                        {count && <Text style={styles.parkTitle}>共找到{count}个公厕</Text>}
                        <ScrollViewer getData={getData} setListView={setListView} props={props} />
                    </View>
                </View>
            </View>
