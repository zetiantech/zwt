...
const AddLivePayLog = ({})=> {
    return (
        ...
        <TouchableOpacity style={styles.warp}>
            <Image style={styles.payimg} source={require('../../../res/images/livepay/icon_electric_small.png')}></Image>
            <View style={{flexDirection:'row',justifyContent:'center',alignItems:'center'}} >
                <Text style={styles.text1}>￥0.1</Text>           
    ...
    return (
        <View >  
            <View style={{flexDirection:'row',backgroundColor:'#fff'}}>           
                ...
                <View style={styles.cardwarp}>
                    <Text style={styles.cardtext1}>广州市供电局有限公司</Text>
...
export default function ComElectrcPay (props) {
    const [data,setdata] = useState ([
        { label: '广州市供电局有限公司', value: '0' }
    ])
