...
function RenderContent({ data, props }) {
    ...
    return (
        <TouchableOpacity
            onPress={() => { NavigationUtil.navigate(props, 'PrivateSchoolsDetail', { info: { ...data, pageTitle: '公办小学招生信息查询' } }) }}
        >
...
export default function PublicPrimarySchool(props) {
    ...
    return (
        <Provider>
            <View style={styles.container}>
                <NavigationBar title='公办小学招生信息查询' hide={false} navigator={props.navigation}
                    popEnabled={true} />
