...
function RenderContent({ data, props }) {
    ...
    return (
        <TouchableOpacity
            onPress={() => { NavigationUtil.navigate(props, 'PrivateSchoolsDetail', { info: { ...data, pageTitle: '民办初中招生信息查询' } }) }}
        >
...
export default function PrivateMiddleSchool(props) {
    ...
    return (
        <Provider>
            <View style={styles.container}>
                <NavigationBar title='民办初中招生信息查询' hide={false} navigator={props.navigation}
                    popEnabled={true} />
